...
exports.getEvents = exports.deleteEvent = exports.updateEvent = exports.getEvent = exports.createEvent = void 0;
...
// @access  Public
exports.getEvents = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    try {
        // Build query
        // Filter
        ...
        let countQuery = Event_1.default.find({});
        // Search
        if (req.query.search) {
            ...
            query = Event_1.default.find(searchCondition);
            countQuery = Event_1.default.find(searchCondition);
        }
        // Genre filter
        if (req.query.genre) {
        ...
        if (req.query.startDate) {
            const startDateCondition = { date: { $gte: new Date(req.query.startDate) } };
            query = query.find(startDateCondition);
            countQuery = countQuery.find(startDateCondition);
        }
        if (req.query.endDate) {
            const endDateCondition = { date: { $lte: new Date(req.query.endDate) } };
